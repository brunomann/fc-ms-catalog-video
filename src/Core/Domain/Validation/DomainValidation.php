...
class DomainValidation
{
    ...
    public static function strMaxLenth(string $value, int $maxLength = 255, $exeptionMessage = null)
    {
    ...
    public static function strMinLenth(string $value, int $minLength = 3, $exeptionMessage = null)
    {
